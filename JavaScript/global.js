...
LightboxInternal.JS = {
	...
	lbDiv.style.width = "710px";
        div.innerHTML = "<div id='imageLBDiv'><div class='chatCloseDiv' onclick=\"LightboxInternal.JS.unblockBg();\" style='float:right;position:relative;left:22px;top:-20px;cursor:pointer;'>" +
                        "<img src='/images/qphome/chat-Close.png'></div><div class=\"nonprofit_blob\" style=\"top:-35px;height:320px;\"><div><div class=\"r7_c2_c1 nonprofit_blob_c1\" > Getting Started </div><div class=\"nonprofit_blob_c2\">To get started with the Non-Profit Waiver Program:</div><div class=\"nonprofit_blob_c3\"><div>1. Register and create a free account with QuestionPro </div><div>2. Add a link to QuestionPro to your Website Home Page </div><div class=\"nonprofit_blob_c4\"><div style=\"top:11px;left:17px;width: 97%;\" align=\"left\"><iframe id=\"nonprofit_iframe\" src=\"" + url + "\" " + "frameborder=\"0\" scrolling=\"no\" style=\"width:100%;\"></iframe></div></div><div style=\"top:26px;height:100px;\"><div style=\"top:3px; width:682px;\">(You are encouraged to modify this and write your own referral to QuestionPro, but it must contain a link to our homepage and include text related to surveys, questionnaires or research)</div><div style=\"top:5px;\">3. After adding the links to your homepage, please send an email to <a href=\"mailto:non-profit@questionpro.com\" style=\"color: #0073C9\">non-profit@questionpro.com</a> and <br>&nbsp;&nbsp;&nbsp;one of our representatives will get back to you shortly.</div></div></div></div></div>";
        var overlayDiv = document.getElementById("lightboxOverlay");
        overlayDiv.style.top = 0;
        overlayDiv.onclick = function() {
            LightboxInternal.JS.unblockBg();
